...
mysqli_query($db,"create table gallery_ids (primary key (`id`)) engine=myisam select floor(substring_index(url,'/',-1)) as id,users,showday,baysian,fetched,first_vote,last_vote from gallery_image where length(title) > 2");
